...
# so writing to /boot there configures nothing. A directory test is not enough: /boot/firmware
# exists as an empty mount point when the partition is not mounted.
