      ...
      return [
        {
          key: 'upload',
          label: 'Upload file',
          description: 'Transfer the .tar archive to Kraken',
          icon: 'mdi-upload',
          status: uploadStatus,
          showProgress: true,
        ...
        },
        {
          ...
          description: 'Import image and inspect metadata',
          icon: 'mdi-docker',
          status: loadStatus,
          showProgress: true,
        ...
        },
        {
          ...
          description: 'Stream Docker pull progress',
...
.upload-phase.complete .upload-phase__title {
  color: #4CAF50;
}

.upload-phase.active .upload-phase__title {
  color: #2196F3;
}

.upload-phase.error .upload-phase__title {
  color: #FF5252;
}
