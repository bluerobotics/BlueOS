<template>
  <div v-if="params_finished_loaded" class="pt-1 pb-1">
    <v-sheet class="ma-3 pa-1 d-flex flex-row flex-wrap flex-grow-0 justify-center">
      <failsafe-card
    ...
    async get_failsafes(): Promise<FailsafeDefinition[]> {
      const failsafes: FailsafeDefinition[] = [
        ...
        },
        {
          ...
          generalDescription: 'Triggers when the internal temperature is too high. This may help preventing '
