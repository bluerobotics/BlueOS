...
from commonwealth.utils.DHCPServerManager import DHCPServerLease
...
@app.get("/dhcp/leases", summary="Get all DHCP leases.")
@version(1, 0)
def get_dhcp_leases() -> Dict[str, List[DHCPServerLease]]:
    """REST API endpoint to get the DHCP leases."""
    return manager.get_dhcp_leases()
