...
class LinuxFlightController(FlightController):
    ...
    def setup(self) -> None:
        os.makedirs("/root/.config/ardupilot-manager/firmware/scripts", exist_ok=True)
        try:
            os.symlink("/root/.config/ardupilot-manager/firmware/scripts", "/shortcuts/lua_scripts")
